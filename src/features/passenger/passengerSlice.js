...
export const addPassengerAsync = createAsyncThunk(
  "passenger/addPassengerAsync",
  async () => {
    debugger;
    const res = await [...state, { ...action.payload }];
    return res;
  }
);
export const passengerSlice = createSlice({
  ...
  extraReducers: {
    [addPassengerAsync.fulfilled]: (state, action) => {
      debugger;
